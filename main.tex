...
name=$T_\mathit{wait}$,
description={Waiting time for the phase match of the frequency beating method},
sort=symbolpi, type=symbolslist
}
...
description={An integral multiple of the derived rf frequency, which is the division of the revolution frequency. It is used for the phase alignment of the two rf systems}
}
