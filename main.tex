...
name=$C^{X}$,
description={X=l, Circumference of the injection/extraction orbit of large synchrotron; X=s, Circumference of the injection/extraction orbit of small synchrotron
},
...
name=$f_{rf}^{X}$,
description={oder $f_{h=cavity\_harmonic}^{X}$.  X=l, Cavity frequency of large synchrotron; X=s, Cavity frequency of small synchrotron},
sort=symbolpi, type=symbolslist
}
...
name=$\Delta Q_x$,
description={Horizontal chromatic tune shift due to the rf frequency modulation},
sort=symbollambda, type=symbolslist
}
\newglossaryentry{symb:c_chromaticity_y}{
name=$\Delta Q_y$,
description={Vertical chromatic tune shift due to the rf frequency modulation},
sort=symbollambda, type=symbolslist
}
...
name=$\gamma(t)$,
description={Relativistic factor, which measures the total particle energy, E(t), in units of the particle rest energy, $E_0$},
sort=symbollambda, type=symbolslist
}
...
name=R(t),
description={Orbit radius. $R_0$ the nominal value},
sort=symbollambda, type=symbolslist
}
...
name={UNILAC},
description={Universal Linear Accelerator},type=abbreslist
}
\newglossaryentry{FRS}{
name={FRS},
...
name={SIS300},
description={Heavy Ion Synchrotron - SchwerIonen Synchrotron (300 Tm magnetic rigidity)},type=abbreslist
}
...
name={CERN},
description={European Organization for Nuclear Research},type=abbreslist
}
\newglossaryentry{IP}{
name={IP},
...
description={Ratio of the revolution frequency of the small to that of the large synchrotrons}
}
...
name={batch},
description={SIS100 batch: Train of 4 $\times$ 2 $U^{28+}$ bunches injected into SIS100 in one SIS18 to SIS100 super cycle. Or train of 4 $\times$ 1 $H^{+}$ bunches injected into SIS100 in one SIS18 to SIS100 super cycle}
}
\newglossaryentry{glos:bunch_gap}{
name={bunch gap},
description={Area without any bunches in the bunch train that fits the time required for building up the nominal field of the kicker}
}
...
\chapter{Concept of the FAIR B2B transfer system ~\cite{bai_concept_2016}}
\input{chapters/4Concept}
\chapter{Application of the FAIR B2B transfer system for FAIR accelerators}
