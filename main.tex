...
name=T,
description={Start time of the rf frequency modulation},
sort=symbolpi, type=symbolslist
}
\newglossaryentry{symb:start_phase}{
name=$t_0$,
description={Period of frequency modulation},
sort=symbolpi, type=symbolslist
}
...
\newglossaryentry{symb:upper_time_phase_shift}{
name=$T_{phase\underline shift}^{upper\underline bound}$,
description={Upper bound time of the phase shfit process},
sort=symbollambda, type=symbolslist
}
\newglossaryentry{symb:un_upper_time_phase_shift}{
name=$\delta T_{phase\underline shift}^{upper\underline bound}$,
...
name={timing frame},
description={Ethernet frame with 110 bytes frame length}
}
