...
name=$\delta t_{\psi}^X$,
description={Uncertainty of the extrapolated phase in the time domain},
sort=symbollambda, type=B2B_sym_slist
}
...
name=$\delta t_\mathit{w\_start\_rect}$,
...
\chapter{Transfer of Timing Frames for FAIR B2B Transfer System}
