...
description={Phase difference between two synchronization frequencies for the phase shift method, phase mismatch between two synchronization frequencies for the frequency beating method},
sort=symbolpi, type=symbolslist
}
...
name=$\Delta \phi_\mathit{shift\_raw}$,
description={Raw value of the required phase shift for the synchronization frequency},
sort=symbolpi, type=symbolslist
}
\newglossaryentry{symb:raw1_shift_shift}{
name=$\Delta \phi_\mathit{shift\_raw}'$,
description={Raw value of the required phase shift for the revolution frequency},
sort=symbolpi, type=symbolslist
}
...
description={Initial phase of the synchronization frequency},
sort=symbolpi, type=symbolslist
}
...
description={Target time difference between the synchronization frequencies of two synchrotrons in the format of time},
sort=symbollambda, type=symbolslist
}
...
name=$\Delta \varphi^X$,
description={Measured phase deviation between the phase measurement signal and the synchronization reference signal of the synchrotron X by PAM module},
sort=symbollambda, type=symbolslist
}

\newglossaryentry{symb:phase_diff_T0}{
name=$\psi^X$,
description={Extrapolated phase advance between the phase measurement signal and the synchronization reference signal of the synchrotron X by PAP module},
sort=symbollambda, type=symbolslist
}
...
description={Responsible for the data collection of two synchrotrons, the data calculation, the data redistribution and the B2B transfer status check}
}
