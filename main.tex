...
name=$d_{pattern}$ ,
description={Delay compensation for the specified bucket pattern},
sort=symbollambda, type=symbolslist
}
\newglossaryentry{symb:tsrc}{
name=$t_{src}$,
description={Delay compensation between the virtual cavity and the extraction position},
sort=symbollambda, type=symbolslist
}
\newglossaryentry{symb:ttrg}{
name=$t_{trg}$,
description={Delay compensation between the virtual cavity and the injection position},
sort=symbollambda, type=symbolslist
}
\newglossaryentry{symb:temg}{
name=$t_{emg}$,
description={Delay compensation between the virtual RF cavity and the emergency extraction position},
sort=symbollambda, type=symbolslist
}
\newglossaryentry{symb:Demg}{
name=$D_{emg}$,
description={Rising time of the extraction kicker of SIS100},
sort=symbollambda, type=symbolslist
}
