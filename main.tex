...
description={Distance between two crates of the SIS18 extraction kicker},
sort=symbollambda, type=symbolslist
}
\newglossaryentry{symb:D}{
name=$d_\mathit{tank1R-tank2R}$,
description={Distance between the rightmost of the $1^{st}$ crate and the rightmost of the $2^{nd}$ crate of the SIS18 extraction kicker},
sort=symbollambda, type=symbolslist
}
