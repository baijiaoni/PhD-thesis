...
\begin{center}
    ...
    \hline
    $\Delta R/R_\mathit{\_max}$ & $\Delta p/p_\mathit{\_max}$ & $\Delta B/B_\mathit{\_max}$ & $\phi_\mathit{s\_max}$ & $\alpha_b(\phi_{s})_\mathit{\_min}$ & $\Delta{Q_{\mathit{x/y\_max}}}$ \\ \hline
      \tabincell{c}{$H^{+}$ $\pm0.8\cdot10^{-4}$\\$U^\mathit{28+}$ $\pm2.4\cdot10^{-4}$} & $\pm0.008$	& 0 &$\pm6.4^\circ$ &  $80\%$  &  $\pm10^{-2}$\\ \hline
...
\begin{center}
   ...
   $\Delta R/R_\mathit{\_max}$ & $\Delta p/p_\mathit{\_max}$ & $\Delta B/B_\mathit{\_max}$ & $\phi_\mathit{s\_max}$ & $\alpha_b(\phi_{s})_\mathit{\_min}$ & $\Delta{Q_{\mathit{x/y\_max}}}$ \\ \hline
	...
	\tabincell{c}{$H^{+}$ $\pm0.8\cdot10^{-4}$\\$U^\mathit{28+}$ $\pm2.4\cdot10^{-4}$} & 0& $\mp0.008$	& $\pm6.4^\circ$ &  $80\%$  &  $0$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
For the frequency beating method, the rf frequency detuning is done during the SIS18 rf ramp or at the rf flattop. Due to the SIS18 $U^\mathit{28+}$ lattice and the semi-aperture required for the beam, the SIS18 $U^\mathit{28+}$ accepted bending magnetic filed shift is~\cite{liebermann_fair_2013}
\begin{equation}
\frac{\Delta{B}}{B}=-\frac{1}{\alpha_p}\frac{\Delta{R}}{R} = \mp  8 \cdot 10^{-3}
...
\begin{equation}
\frac{\Delta{f}_\mathit{rf}}{f_\mathit{rf}} = \mp 2.4 \cdot 10^{-4}
...
Due to the SIS18 $H^+$ lattice and the semi-aperture required for the beam,, the SIS18 $H^+$ accepted bending magnetic filed shift is
\begin{equation}
\frac{\Delta{B}}{B}=-\frac{1}{\alpha_p}\frac{\Delta{R}}{R} = \mp  8 \cdot 10^{-3}
%\gls{symb:radius} = \pm 2.4 \cdot 10^{-4}
\end{equation}
...
\begin{equation}
\frac{\Delta{f}_\mathit{rf}}{f_\mathit{rf}} = \mp 0.8 \cdot 10^{-4}
%\gls{symb:freq} = \pm 2.4 \cdot 10^{-4}
\end{equation}
