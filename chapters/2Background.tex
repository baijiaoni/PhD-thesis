...
%Y is the GCD of $h^l_\mathit{rf}n$ and $h^s_\mathit{rf} m$. In this scenario, the phase difference between two rf systems varies periodically. There is one time of point within the beating period, when two rf systems match phase.  The beating frequency is
%\begin{equation} 
%\Delta f=|f_{\mathit{syn}}^{l}-f_{\mathit{syn}}^{s}|
%\end{equation}
...
\begin{equation}
T_{w\_max}=\frac{2|\Delta \phi_\mathit{rf\_max}|\cdot\frac{h_\mathit{syn}^\mathit{trg}}{h_\mathit{rf}^\mathit{trg}}}{2\pi}\cdot\frac{1}{|f_{\mathit{syn}}^\mathit{src}-f_{\mathit{syn}}^\mathit{trg}|}
\end{equation}
