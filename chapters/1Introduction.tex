...
\begin{figure}[!htb]
   ...
   \caption{Bunch-to-bucket injection with phase and energy error.}{Bunch-to-bucket injection with phase and energy error. X-axis: Phase in radian. Y-axis: momentum, energy or frequency deviation
...
\begin{figure}[H]
   ...
   \caption{Structure of the dissertation.}{Structure of the dissertation. Contributions are marked blue and red is team work; existing system or theory are not colored.}
