...
The transition of the magnetic field must be carried out during bunch gaps, which depend on the cavity rf frequency, the bucket pattern and the bunch length. 
...
\begin{equation}
\Delta \phi=\pm\frac{1}{2}\frac{T_{\mathit{sync\_win}}}{1/\Delta f}\cdot360^\circ\cdot\frac{f_{\mathit{rf}}^{trg}}{f_{\mathit{syn}}^{trg}}
\end{equation}
