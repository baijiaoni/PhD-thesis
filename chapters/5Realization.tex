...
\begin{center}
    ...
    \hline
     \tabincell{c}{Average \\radial\\ excursion} & \tabincell{c}{Relative\\moment\\ shift} &\tabincell{c}{Synchronous\\phase} & \tabincell{c}{Bucket\\size} &\tabincell{c}{Adiabaticity} & \tabincell{c}{Chromaticity\\tune\\ shift/tune} \\ \hline
      \tabincell{c}{$H^{+}$ $\pm0.8\cdot10^{-4}$\\$U^\mathit{28+}$ $\pm2.4\cdot10^{-4}$} & $\pm0.008$	& $\pm10^\circ$ &  $>80\%$  &  $<2\cdot10^{-4}$ & $<\pm10^{-3}$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{equation}
\frac{\Delta Q_x}{Q_x} = \frac{-9.1 \cdot 10^{-4}}{4.17}=-2.18 \cdot 10^{-4}
\end{equation}
\begin{equation}
\frac{\Delta Q_y}{Q_y} = \frac{-5.74\cdot 10^{-4}}{3.4} =-1.69 \cdot 10^{-4}
\end{equation}
...
The percentage of the chromatic tune shift to the tune is
\begin{equation}
\frac{\Delta Q_x}{Q_x} = \frac{-2.925 \cdot 10^{-3}}{4.17}=-7.01 \cdot 10^{-4}
\end{equation}
\begin{equation}
\frac{\Delta Q_y}{Q_y} = \frac{-1.716\cdot 10^{-3}}{3.4} =-5.05 \cdot 10^{-4}
\end{equation}
...
\begin{equation}
t_\mathit{align}= t_\psi^\mathit{X}+\frac{\Delta \phi_\mathit{shift}}{2\pi}\cdot\frac{1}{|f_{\mathit{syn}}^\mathit{src}-f_{\mathit{syn}}^\mathit{trg}|}+ n\cdot \frac{1}{|f_{\mathit{syn}}^\mathit{src}-f_{\mathit{syn}}^\mathit{trg}|}
...
\frac{\Delta \phi_\mathit{shift}}{2\pi}\cdot\frac{1}{|f_{\mathit{syn}}^\mathit{src}-f_{\mathit{syn}}^\mathit{trg}|}+n\cdot \frac{1}{|f_{\mathit{syn}}^\mathit{src}-f_{\mathit{syn}}^\mathit{trg}|}-\frac{T_w}{2}-t_\mathit{delay} & \textit{Frequency beating method}\cr
\end{cases}
\end{eqnarray}
