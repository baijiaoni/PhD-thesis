\section{Investigation from the beam dynamics view for two synchronization methods of $U^{28+}$ for SIS18}
...
\subsection{Longitudinal dynamic analysis for the simulation}
\begin{itemize}
