...
For both the phase shift and frequency beating method, the calculation is based on the predicted phase advance. The phase advance prediction module extropolates the rf phase $\psi_{h=1}^{SIS100}$ for SIS100 rf h=1 (157kHz) signal and $\psi_{h=1/5}^{SIS18}$ for SIS18 rf h=1/5 (157kHz) signal at $t_{\psi}$. The more time is spent for the phase advance prediction, the better the predicted phase will be. More details about the phase advance measurement and phase advance prediction modules, please see Tibo's thesis. Fig.~\ref{Calculation_symble} illustrates some basic definition of symbols for the calculation. 
\begin{figure}[!htb]
   \centering   
...
\begin{figure}[!htb]
   \centering   
   \includegraphics*[width=160mm]{GSI_use_case.jpg}
...
\caption{The VLAN and priority for the traffic of the WR network for FAIR}
...
\begin{center}
    ...
    \hline
     \tabincell{c}{Switch} & \tabincell{c}{Xena \\ Port} & \tabincell{c}{Traffic} &\tabincell{c}{ VLAN} &\tabincell{c}{Priority} &\tabincell{c}{Usage}\\ \hline
        \multirow{6}{*}{WR switch 1}  
                 & Port 1 & 100 Mbit/s 110bytes & 7 & 7 & DM Broadcast \\ \hline
					 & Port 2 & Rx traffic &  &  &  \\ \hline
					 & Port 3 & 10 Mbit/s 110bytes & 7 & 7 & DM Unicast \\ \hline
   					 & Port 4 & Rx traffic &  &  &  \\ \hline
					 & Port 5 & Rx traffic &  &  &  \\ \hline
					 & Port 6 & 1 Mbit/s 64 - 1518 bytes & 5 & 5 &  \tabincell{c}{Management \\ Broadcast} \\ \hline
   \tabincell{c}{WR switch \\ 1} & Port 7 & 2 Mbit/s 64 - 1518 bytes& 5 & 5 &  \tabincell{c}{Management \\ Broadcast} \\ \hline
	\tabincell{c}{WR switch \\ 1} & Port 8 & Rx traffic &  &  & \\ \hline
	\tabincell{c}{WR switch \\ 1} & Port 9 & Rx traffic &  &  & \\ \hline
   \tabincell{c}{WR switch \\ 1} & Port 10 & 1 Mbit/s 64 - 1518 bytes& 5 & 5 &  \tabincell{c}{Management \\ Broadcast} \\ \hline
	\tabincell{c}{WR switch \\ 1} & Port 11 & Rx traffic &  &  & \\ \hline
