Due to the ratio of the circumference of the injection/extraction orbit, there are several use cases of the B2B transfer for FAIR. 
\begin{itemize}
...
In this document, the circumference of the injection/extraction orbit of the synchrotron is denoted by $C^{X}$, the revolution frequency and rf cavity frequency by $f_{\mathit{rev}}^{X} $ and $f_{\mathit{rf}}^{X}$, the beating frequency by \gls{symb:beating_freq} and the harmonic number by $h^X$. The superscript X could be either ``l`` or ``s`` denoting the large or small synchrotron. $\kappa$ is used to represent integers and $\lambda$ the decimal numbers.
...
\begin{center}
    ...
    \hline
	\tabincell{c}{Circumference\\ ratio} &  $C^l/C^s$ &$\frac{ f_{rev}^{s}}{ f_{rev}^{l}}$& use case of FAIR accelerators\\ \hline
...
\begin{table}[!htb]
\newcommand{\tabincell}[2]{\begin{tabular}{@{}#1@{}}#2\end{tabular}}
\caption{Synchronization when the circumference ratio is an integer}{(the period of the beating frequency is longer than the revolution period)}
...
\begin{table}[!htb]
\newcommand{\tabincell}[2]{\begin{tabular}{@{}#1@{}}#2\end{tabular}}
\caption{Synchronization when the revolution frequency ratio is an integer}{(the period of the beating frequency is shorter than the revolution period)}
...
\subsubsection{use case of the $U^{28+}$ B2B transfer from SIS18 to SIS100}
...
Substituting $h^X$, $\kappa$, $f_{rf}^{X}$, $f_{rev}^{X}$ and $Y$ into formulas in Tab.~\ref{Syn_rev_ratio_int}, the synchronization of $U^{28+}$ B2B transfer from SIS18 to SIS100 is obtained, see Tab.~\ref{tab:U18to100}. Here we assume that SIS18 is detuned with \SI{200}{Hz} for the frequency beating method. 
\begin{table}[!htb]
\newcommand{\tabincell}[2]{\begin{tabular}{@{}#1@{}}#2\end{tabular}}
...
If the ratio of the circumference of the injection/extraction orbit of the large synchrotron to that of the small synchrotron is not an integer, $\kappa$ could be expressed as $\iota + \lambda$ and we have the following relation.
\begin{equation}
...
When the circumference ratio of the large synchrotron to that of the small synchrotron is very close to an integer, $\iota$ in eq. ~\ref{circumference_ratio_noint} is an integer and $\lambda$ has the order of magnitude $10^{-2}$.
%\begin{equation}
...
\begin{table}[!htb]
\newcommand{\tabincell}[2]{\begin{tabular}{@{}#1@{}}#2\end{tabular}}
\caption{Synchronization when circumference ratio is close to an integer}
...
When the circumference ratio of the large synchrotron to that of the small synchrotron is far away from an integer, $\iota$ in eq.~\ref{circumference_ratio_noint} could be denoted by $\frac{m}{n}$ (m and n are integers) and eq.~\ref{circumference_ratio_noint} could be expressed as
...
Besides, it is also grouped to this scenario, that the revolution frequency ratio between the small and large synchrotrons is far away from an interger when the beam passes some target (e.g. FRS, Pbar) between two synchrotrons. The revolution frequency ratio can be expressed as
\begin{equation} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{use case of $H^{+}$ B2B transfer from SIS100 to CR} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{use case of RIB B2B transfer from SIS100 to CR} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{use case of B2B transfer from CR to HESR} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{use case of B2B transfer from SIS18 to ESR via FRS} 
