...
%
% &&1.8+0.048& 1&1 & $\frac{h^l_\mathit{rf}}{h^s_\mathit{rf} \cdot (m/n+ \lambda)}=\frac{9}{5}+0.048$ & \tabincell{c}{B2B transfer \\from the SIS18 to the ESR via FRS} \\ \hline
% 
%
%    \end{tabular}
%\end{center}
...
%For the phase shift method, the bucket indication signal indicates neither all of the time ($f_{\mathit{rev}}^{l}$ or $f_{\mathit{rev}}^{s}$), when the first bucket of the target synchrotron passes by the rf virtual cavity, nor all of the time ($\frac{f_{\mathit{rf}}^{l}}{h^l_\mathit{rf}/Y}$ or $\frac{f_{\mathit{rf}}^{s}}{(h^s_\mathit{rf}\cdot \kappa)/Y}$), when the phase of two rf systems are aligned. It indicates only the passing time of the first bucket, when it is phase aligned with the rf system of the source synchrotron, see Fig. ~\ref{bucket_label_phase}.
 
%rev_or_subharmonic.docx
%\begin{figure}[!htb]
%   \centering   
%   \includegraphics*[width=130mm]{bucket_label_phase.jpg}
%   \caption{The frequency of the bucket indication signal for the phase shift method.}{The red dots represent buckets and the blue ones bunches, the black bars chosen by blue rectangle are used by the bucket indication signal. The phase of two rf systems in this example is aligned at $0$.}
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{rev}}^{l}$\\ \hline
	\tabincell{c}{$f_\mathit{syn}^\mathit{X}$} & $f_\mathit{syn}^\mathit{s}=\frac{f_{\mathit{rf}}^{s}}{h^s_\mathit{rf}\kappa/Y}$ and $f_\mathit{syn}^\mathit{l}=\frac{f_\mathit{rf}^\mathit{l}}{h^l_\mathit{rf}/Y}$ \\ \hline
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{rev}}^{s}$ & $f_{\mathit{syn}}^{s}$ \\ \hline
	\tabincell{c}{$f_\mathit{syn}^\mathit{X}$} & \multicolumn{2}{c|}{$f_\mathit{syn}^\mathit{s}=\frac{f_{\mathit{rf}}^{s}}{h^s_\mathit{rf}\kappa/Y}$ and $f_\mathit{syn}^\mathit{l}=\frac{f_\mathit{rf}^\mathit{l}}{h^l_\mathit{rf}/Y}$} \\ \hline
...
%	\tabincell{c}{$\Delta \phi_\mathit{rf}$}&$\pm\frac{1}{2}\cdot\frac{2\cdot T_{\mathit{rev}}^{l}}{1/\Delta f}\cdot2\pi$ & $\pm\frac{1}{2}\cdot\frac{2\cdot T_{\mathit{rev}}^{s}}{1/\Delta f}\cdot2\pi$\\ \hline
%    \end{tabular}
%\end{center}
%\end{table}
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{rev}}^{\mathit{SIS100}}=\SI{157.254}{kHz}$\tablefootnote{A Group DDS produces a given frequency with the \SI{}{mHz} order of magnitude precision}  \\ \hline
	\tabincell{c}{$f_\mathit{syn}^\mathit{X}$} &  \tabincell{c}{$f_{\mathit{syn}}^{SIS18}=2f_{\mathit{rev}}^{\mathit{SIS18}}=$\SI{1.572536}{MHz} \\and\\ $f_{\mathit{syn}}^{SIS100}=10 f_{\mathit{rev}}^{\mathit{SIS100}}$=\SI{1.572536}{MHz}}\\ \hline
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{rev}}^{\mathit{SIS100}}=\SI{271.872}{kHz}$  \\ \hline
	\tabincell{c}{$f_\mathit{syn}^\mathit{X}$} &   \tabincell{c}{$f_{\mathit{syn}}^{SIS18}=f_{\mathit{rev}}^{\mathit{SIS18}}$=\SI{1.359358}{MHz} \\and\\ $f_{\mathit{syn}}^{SIS100}=5f_{\mathit{rev}}^{\mathit{SIS100}}$=\SI{1.359358}{MHz}}\\ \hline
...
\begin{center}
	...
	&  Large synchrotron is target synchrotron \\ \hline
   $f_\mathit{bucket}$ & $f_{\mathit{rev}}^{l}$\\ \hline
	\tabincell{c}{$f_\mathit{syn}^\mathit{X}$} & $f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{s}}{(h^s_\mathit{rf}\cdot \kappa)/Y}$ and $f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{l}}{h^l_\mathit{rf}/Y}$ \\ \hline
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{rev}}^{s}$ &$f_{\mathit{syn}}^{s}$ \\ \hline
	\tabincell{c}{$f_\mathit{syn}^\mathit{X}$} & \multicolumn{2}{c|}{$f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{s}}{(h^s_\mathit{rf}\cdot \kappa)/Y}$ and $f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{l}}{h^l_\mathit{rf}/Y}$} \\ \hline
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{rev}}^{l}$ &$f_{\mathit{syn}}^{l}$ \\ \hline
	\tabincell{c}{$f_\mathit{syn}^\mathit{X}$} & \multicolumn{2}{c|}{$f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{s}}{(h^s_\mathit{rf}\cdot m)/Y}$ and $f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{l}}{(h^l_\mathit{rf}\cdot n)/Y}$}\\ \hline
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{syn}}^{CR}=\SI{54.866}{\kHz}$  \\ \hline
	\tabincell{c}{$f_\mathit{syn}^\mathit{X}$} & $f_{\mathit{syn}}^{SIS100}=f_{\mathit{rev}}^{\mathit{SIS100}}/5=\SI{55.316}{\kHz}$ and $f_{\mathit{syn}}^{CR}=f_{\mathit{rev}}^{\mathit{CR}}/24=\SI{54.866}{\kHz}$\\ \hline
...
\begin{center}
 ...
 \tabincell{c}{$C^l/C^s=\kappa$ \\Integer} &  \tabincell{c}{$\frac{h^l_\mathit{rf}}{h^s_\mathit{rf}\cdot \kappa}$\\ \\ \tabincell{c}{Y=GCD$(h^l_\mathit{rf},h^s_\mathit{rf} \kappa)$}} & \tabincell{c}{$f_{\mathit{rev}}^{l}$} & \tabincell{c}{$f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{s}}{(h^s_\mathit{rf}\cdot \kappa)/Y}$\\ and\\ $f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{l}}{h^l_\mathit{rf}/Y}$\\ \\ $\Delta f=\Delta f_\mathit{syn}$} &\tabincell{c}{$f_\mathit{B2B}^\mathit{s}=\frac{h_{\mathit{rev}}^{l}}{h_{\mathit{syn}}^{l}}\cdot (f_{\mathit{syn}}^{s}+\Delta f_\mathit{syn})$ \\and \\$f_\mathit{B2B}^\mathit{l}=f_{\mathit{rev}}^{l}$} \\ \hline
											
 	\tabincell{c}{$C^l/C^s=\kappa+ \lambda$ \\ or \\ $f{\mathit{rev}}^{s}/f{\mathit{rev}}^{l}=\kappa+ \lambda$\\close to integer }&\tabincell{c}{$\frac{h^l_\mathit{rf}}{h^s_\mathit{rf}\cdot (\kappa+ \lambda)}$\\ \\ \tabincell{c}{Y=GCD$(h^l_\mathit{rf},h^s_\mathit{rf} \kappa)$}} & \tabincell{c}{$f_{\mathit{rev}}^{l}$} & \tabincell{c}{$f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{l}}{h^l_\mathit{rf}/Y}$ \\and \\$f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{s}}{(h^s_\mathit{rf}\cdot \kappa)/Y}$ \\ \\$\Delta f=|f_{\mathit{syn}}^{l}-f_{\mathit{syn}}^{s}|$} &\tabincell{c}{$f_\mathit{B2B}^\mathit{s}=\frac{h_{\mathit{rev}}^{l}}{h_{\mathit{syn}}^{l}}\cdot f_{\mathit{syn}}^{s}$ \\and \\$f_\mathit{B2B}^\mathit{l}=f_{\mathit{rev}}^{l}$}   \\ \hline


\tabincell{c}{$C^l/C^s=m/n+ \lambda$ \\ or \\ $f{\mathit{rev}}^{s}/f{\mathit{rev}}^{l}=m/n+ \lambda$\\far away from integer}
&\tabincell{c}{ $\frac{h^l_\mathit{rf}}{h^s_\mathit{rf} \cdot (m/n+ \lambda)}$\\ \\ \tabincell{c}{Y=GCD$(h^l_\mathit{rf} n,h^s_\mathit{rf}  m)$}}& \tabincell{c}{if $Y/n\ge1, f_{\mathit{rev}}^{l}$  \\ \\ \color{red}{if $Y/n<1, f_{\mathit{syn}}^{l}$}} & \tabincell{c}{$f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{l}}{(h^l_\mathit{rf}\cdot n)/Y}$\\ and\\ $f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{s}}{(h^s_\mathit{rf}\cdot m)/Y}$ \\ \\$ \Delta f=|f_{\mathit{syn}}^{l}-f_{\mathit{syn}}^{s}|$}  

&\tabincell{c}{$f_{\mathit{B2B}}^{s}=\frac{h_{\mathit{rev}}^{l}}{h_{\mathit{syn}}^{l}}\cdot f_{\mathit{syn}}^{s}$ \\and\\ $f_{\mathit{B2B}}^{l}=f_{\mathit{rev}}^{l}$ \\ \\ \color{red}{$f_{\mathit{B2B}}^{s}=f_{\mathit{syn}}^{s}$}\\ \color{red}{and}\\ \color{red}{$f_{\mathit{B2B}}^{l}=f_{\mathit{syn}}^{l}$}}\\ \hline

\multicolumn{5}{|l|}{\textit{Note:} $f_\mathit{ref}=\textit{round} (f_\mathit{bucket}/\SI{100}{kHz})\cdot \SI{100}{kHz}$, $T_w=1/f_{\mathit{bucket}}$ and $\Delta \phi_\mathit{rf}=\pm \frac{1}{2}\cdot 2\pi|f_{\mathit{syn}}^\mathit{s}-f_{\mathit{syn}}^\mathit{l}|\cdot T_\mathit{w} \cdot \frac{h_{\mathit{rf}}^\mathit{l}}{h_{\mathit{syn}}^\mathit{l}}$} \\ \hline
    \end{tabular}
\end{center}
\end{table}
\end{landscape} 
...
& \tabincell{c}{$Y/\kappa\ge1, f_{\mathit{rev}}^{s}$} & \tabincell{c}{$f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{l}}{h^l_\mathit{rf}/Y}$ \\and \\$f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{s}}{(h^s_\mathit{rf}\cdot \kappa)/Y}$\\ \\ $\Delta f=\Delta f_\mathit{syn}$}
&\tabincell{c}{$f_\mathit{B2B}^\mathit{l}=\frac{h_{\mathit{rev}}^{s}}{h_{\mathit{syn}}^{s}}\cdot (f_{\mathit{syn}}^{l}+\Delta f_\mathit{syn})$ \\and\\ $f_\mathit{B2B}^\mathit{s}=f_{\mathit{rev}}^{s}$}\\ \hline
...
& \tabincell{c}{$f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{l}}{h^l_\mathit{rf}/Y}$ \\and \\$f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{s}}{(h^s_\mathit{rf}\cdot \kappa)/Y}$ \\ \\ $\Delta f=|f_{\mathit{syn}}^{l}-f_{\mathit{syn}}^{s}|$}
& \tabincell{c}{$f_\mathit{B2B}^\mathit{l}=\frac{h_{\mathit{rev}}^{s}}{h_{\mathit{syn}}^{s}}\cdot f_{\mathit{syn}}^{l}$ \\and\\ $f_\mathit{B2B}^\mathit{s}=f_{\mathit{rev}}^{s}$} \\ \hline
...
& \tabincell{c}{$f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{l}}{(h^l_\mathit{rf}\cdot n)/Y}$ \\and\\ $f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{s}}{(h^s_\mathit{rf}\cdot m)/Y}$ \\ \\$ \Delta f=|f_{\mathit{syn}}^{l}-f_{\mathit{syn}}^{s}|$} 
&\tabincell{c}{$f_\mathit{B2B}^\mathit{l}=\frac{h_{\mathit{rev}}^{s}}{h_{\mathit{syn}}^{s}}\cdot f_{\mathit{syn}}^{l}$ \\and\\ $f_\mathit{B2B}^\mathit{s}=f_{\mathit{rev}}^{s}$} \\ \hline

\multicolumn{5}{|l|}{\textit{Note:} $f_\mathit{ref}=\textit{round} (f_\mathit{bucket}/\SI{100}{kHz})\cdot \SI{100}{kHz}$, $T_w=1/f_{\mathit{bucket}}$ and $\Delta \phi_\mathit{rf}=\pm \frac{1}{2}\cdot 2\pi|f_{\mathit{syn}}^\mathit{s}-f_{\mathit{syn}}^\mathit{l}|\cdot T_\mathit{w} \cdot \frac{h_{\mathit{rf}}^\mathit{s}}{h_{\mathit{syn}}^\mathit{s}}$} \\ \hline
    \end{tabular}
\end{center}
\end{table}
\end{landscape} 
...
& \tabincell{c}{$f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{l}}{h^l_\mathit{rf}/Y}$ \\and\\ $f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{s}}{(h^s_\mathit{rf}\cdot \kappa)/Y}$ \\ \\ $\Delta f=\Delta f_\mathit{syn}$}
