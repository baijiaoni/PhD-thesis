...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{rev}}^{l}$\\ \hline
	...
	\tabincell{c}{$\Delta \phi_\mathit{rf}$}&$\pm (\frac{1}{2}\cdot 2\pi|f_{\mathit{syn}}^\mathit{l}-f_{\mathit{syn}}^\mathit{s}|T_\mathit{w}\cdot \frac{(h^\mathit{l}_\mathit{inj}-1)}{h^\mathit{l}} \cdot  \frac{f_{\mathit{rf}}^\mathit{l}}{f_{\mathit{syn}}^\mathit{l}}+\Delta \phi_\mathit{step})$ \\ \hline
    \end{tabular}
\end{center}
\end{table}
...
When the small synchrotron is the target, the relation between $f_{\mathit{syn}}^{s}=\frac{Y}{\kappa}f_{\mathit{rev}}^{s}$ and $f_{\mathit{rev}}^{s}$ is not fixed. If $f_{\mathit{syn}}^{s}\ge f_{\mathit{rev}}^{s}$, namely $\frac{Y}{\kappa}\ge 1$, the revolution period is $\frac{Y}{\kappa}$ times as long as the period of $f_{\mathit{syn}}^{s}$. Hence, $f_\mathit{bucket}=f_{\mathit{rev}}^{s}$ and $T_w=2T_{\mathit{rev}}^{s}$ for this case.
...
Oppositely,  if $f_{\mathit{syn}}^{s}<f_{\mathit{rev}}^{s}$, namely $\frac{Y}{\kappa}<1$, the period of $f_{\mathit{syn}}^{s}$ is $\frac{\kappa}{Y}$ times as long as the revolution period. Hence, $f_\mathit{bucket}=f_{\mathit{syn}}^{s}$ and $T_w=2T_{\mathit{syn}}^{s}$. Tab.~\ref{Sync_ratio_int} shows the formulas when the small synchrotron is the target.
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{rev}}^{s}$ & $f_{\mathit{syn}}^{s}$ \\ \hline
	...
	\tabincell{c}{$\Delta \phi_\mathit{rf}$}& \multicolumn{2}{c|}{$\pm (\frac{1}{2}\cdot 2\pi|f_{\mathit{syn}}^\mathit{l}-f_{\mathit{syn}}^\mathit{s}|T_\mathit{w}\cdot \frac{(h^\mathit{s}_\mathit{inj}-1)}{h^\mathit{s}} \cdot  \frac{f_{\mathit{rf}}^\mathit{s}}{f_{\mathit{syn}}^\mathit{s}}+\Delta \phi_\mathit{step})$ }\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{rev}}^{\mathit{SIS100}}=\SI{157.254}{kHz}$\tablefootnote{A Group DDS produces a given frequency with the \SI{}{mHz} order of magnitude precision}  \\ \hline
	...
	\tabincell{c}{$f_\mathit{B2B}^\mathit{X}$} &  \tabincell{c}{$f_\mathit{B2B}^\mathit{SIS18}=\frac{1}{5}(f_{\mathit{rev}}^{\mathit{SIS18}}+\frac{1}{2}\Delta f_\mathit{syn})=$\SI{157.254}{kHz}+\SI{20}{Hz} \\and\\ $f_\mathit{B2B}^\mathit{SIS100}$=\SI{157.254}{kHz}}\\ \hline
	\tabincell{c}{$f_\mathit{syn}^\mathit{REF}$} & \SI{200}{kHz}\\ \hline
	\tabincell{c}{$T_w$}& $2T_{\mathit{rev}}^{\mathit{SIS100}}=\SI{12.718}{us}$\\ \hline
	\tabincell{c}{$\Delta \phi_\mathit{rf}$}&$\pm0.8^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{rev}}^{\mathit{SIS100}}=\SI{271.872}{kHz}$  \\ \hline
	...
	\tabincell{c}{$f_\mathit{B2B}^\mathit{X}$} &  \tabincell{c}{$f_\mathit{B2B}^\mathit{SIS18}=\frac{1}{5}(f_{\mathit{rev}}^{SIS18}+\Delta f_\mathit{syn})=$\SI{271.872}{kHz}+\SI{40}{Hz} \\and\\ $f_{\mathit{B2B}}^{SIS100}$=\SI{271.872}{kHz}}\\ \hline
	\tabincell{c}{$f_\mathit{syn}^\mathit{REF}$} & \SI{300}{kHz}\\ \hline

	\tabincell{c}{$T_w$}& $2T_{\mathit{rev}}^{\mathit{SIS100}}=\SI{7.356}{us}$ \\ \hline
	\tabincell{c}{$\Delta \phi_\mathit{rf}$}&$\pm0.7^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
%%%%%%%%%%%
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{syn}}^{CRYRING}=\SI{686.600}{kHz}$  \\ \hline
	\tabincell{c}{$f_\mathit{syn}^\mathit{X}$} & \tabincell{c}{$f_{\mathit{syn}}^{ESR}=f_{\mathit{rf}}^{\mathit{ESR}}=\SI{685.651}{kHz}$ \\and \\$f_{\mathit{syn}}^{CRYRING}=f_{\mathit{rf}}^{\mathit{CRYRING}}/2$=\SI{686.600}{kHz}}\\ \hline
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{rev}}^{l}$ &$f_{\mathit{syn}}^{l}$ \\ \hline
	...
	\tabincell{c}{$\Delta \phi_\mathit{rf}$}&\multicolumn{2}{c|}{$\pm (\frac{1}{2}\cdot 2\pi|f_{\mathit{syn}}^\mathit{l}-f_{\mathit{syn}}^\mathit{s}|T_\mathit{w}\cdot \frac{(h^\mathit{l}_\mathit{inj}-1)}{h^\mathit{l}} \cdot  \frac{f_{\mathit{rf}}^\mathit{l}}{f_{\mathit{syn}}^\mathit{l}}+\Delta \phi_\mathit{step})$}\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\end{center}
\end{table}
There exists an inherent big bunch-to-bucket injection center mismatch. If this mismatch is not acceptable, other injection method will be used for the transfer (e.g. the coasting beam injection), which is beyond the scope of this dissertation. Detailed parameters of the $H^{+}$ B2B transfer from the SIS100 to the CR , please see Appendix \ref{100toCR}.
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{syn}}^{ESR}=\SI{219.642}{\kHz}$  \\ \hline
	...
	\tabincell{c}{$\Delta \phi_\mathit{rf}$}&$\pm62.3^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}

There exists an inherent big bunch-to-bucket injection center mismatch. If this mismatch is not acceptable, other injection method will be used for the transfer (e.g. the coasting beam injection), which is beyond the scope of this dissertation. More parameters about the B2B transfer from the SIS18 to the ESR via a FRS, please see Appendix \ref{sec:18toESRvia FRS}.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\multicolumn{5}{|l|}{\textit{Note:} $f_\mathit{syn}^\mathit{REF}=\textit{round} (f_\mathit{bucket}/\SI{100}{kHz})\cdot \SI{100}{kHz}$, $T_w=2/f_{\mathit{bucket}}$ and $\Delta \phi_\mathit{rf}=\pm (\frac{1}{2}\cdot 2\pi|f_{\mathit{syn}}^\mathit{l}-f_{\mathit{syn}}^\mathit{s}|T_\mathit{w}\cdot \frac{(h^\mathit{l}_\mathit{inj}-1)}{h^\mathit{l}} \cdot  \frac{f_{\mathit{rf}}^\mathit{l}}{f_{\mathit{syn}}^\mathit{l}}+\Delta \phi_\mathit{step})$} \\ \hline
    \end{tabular}
\end{center}
\end{table}
\end{landscape} 
...
\multicolumn{5}{|l|}{\textit{Note:} $f_\mathit{syn}^\mathit{REF}=\textit{round} (f_\mathit{bucket}/\SI{100}{kHz})\cdot \SI{100}{kHz}$, $T_w=2/f_{\mathit{bucket}}$ and $\Delta \phi_\mathit{rf}=\pm (\frac{1}{2}\cdot 2\pi|f_{\mathit{syn}}^\mathit{l}-f_{\mathit{syn}}^\mathit{s}|T_\mathit{w}\cdot \frac{(h^\mathit{s}_\mathit{inj}-1)}{h^\mathit{s}} \cdot  \frac{f_{\mathit{rf}}^\mathit{s}}{f_{\mathit{syn}}^\mathit{s}}+\Delta \phi_\mathit{step})$} \\ \hline
    \end{tabular}
\end{center}
\end{table}
\end{landscape} 
