...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{\mathit{SIS100}}=\SI{0.157254}{MHz}$  \\ \hline
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{\mathit{SIS100}}=\SI{0.135936}{MHz}$  \\ \hline
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{\mathit{ESR}}=\SI{0.685651}{\MHz}$  \\ \hline
