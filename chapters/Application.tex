...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{rev}}^{l}$\\ \hline
	...
	\tabincell{c}{$\Delta \phi_\mathit{rf}$}&$\pm \frac{1}{2}\cdot 2\pi|f_{\mathit{syn}}^\mathit{s}-f_{\mathit{syn}}^\mathit{l}|\cdot T_\mathit{w} \cdot \frac{f_{\mathit{rf}}^\mathit{l}}{f_{\mathit{syn}}^\mathit{l}}$ \\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{rev}}^{\mathit{SIS100}}=\SI{157.254}{kHz}$\tablefootnote{A Group DDS produces a given frequency with the \SI{}{mHz} order of magnitude precision}  \\ \hline
	...
	\tabincell{c}{$T_w$}& $T_{\mathit{rev}}^{\mathit{SIS100}}=\SI{6.359}{us}$\\ \hline
	\tabincell{c}{$\Delta \phi_\mathit{rf}$}&$\pm0.4^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{rev}}^{\mathit{SIS100}}=\SI{271.872}{kHz}$  \\ \hline
	...
	\tabincell{c}{$T_w$}& $T_{\mathit{rev}}^{\mathit{SIS100}}=\SI{3.678}{us}$ \\ \hline
	\tabincell{c}{$\Delta \phi_\mathit{rf}$}&$\pm0.4^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{rev}}^{\mathit{ESR}}=\SI{685.651}{\kHz}$  \\ \hline
	...
	\tabincell{c}{$T_w$}& $T_{\mathit{rev}}^{\mathit{ESR}}=\SI{1.456}{us}$ \\ \hline
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{syn}}^{ESR}=\SI{988.388}{\kHz}$  \\ \hline
	...
	\tabincell{c}{$T_w$}& $T_{\mathit{syn}}^{\mathit{ESR}}=\SI{1.017}{us}$ \\ \hline
	\tabincell{c}{$\Delta \phi_\mathit{rf}$}&$\pm0.5^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{syn}}^{CRYRING}=\SI{686.600}{kHz}$  \\ \hline
	...
	\tabincell{c}{$T_w$}& $T_{\mathit{syn}}^{\mathit{CRYRING}}=\SI{1.456}{us}$ \\ \hline
	\tabincell{c}{$\Delta \phi_\mathit{rf}$}&$\pm0.5^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{rev}}^{l}$ &$f_{\mathit{syn}}^{l}$ \\ \hline
	...
	\tabincell{c}{$\Delta \phi_\mathit{rf}$}&\multicolumn{2}{c|}{$\pm \frac{1}{2}\cdot 2\pi|f_{\mathit{syn}}^\mathit{s}-f_{\mathit{syn}}^\mathit{l}|\cdot T_\mathit{w} \cdot \frac{f_{\mathit{rf}}^\mathit{l}}{f_{\mathit{syn}}^\mathit{l}}$}\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{syn}}^{CR}=\SI{54.866}{\kHz}$  \\ \hline
	...
	\tabincell{c}{$T_w$}& $T_{\mathit{syn}}^{CR}=\SI{18.226}{us}$ \\ \hline
	\tabincell{c}{$\Delta \phi_\mathit{rf}$}&$\pm35.5^\circ$\\ \hline
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{syn}}^{CR}=\SI{102.218}{\kHz}$  \\ \hline
	...
	\tabincell{c}{$T_w$}& $T_{\mathit{syn}}^{CR}=\SI{9.779}{us}$ \\ \hline
	\tabincell{c}{$\Delta \phi_\mathit{rf}$}&$\pm2.1^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
	...
	\tabincell{c}{$T_w$}& $T_{\mathit{syn}}^{HESR}=\SI{9.860}{us}$ \\ \hline
	\tabincell{c}{$\Delta \phi_\mathit{rf}$}&$\pm1.2^\circ$\\ \hline
		\rowcolor[gray]{0.8}
	...
	\tabincell{c}{$T_w$}& $T_{\mathit{syn}}^{HESR}=\SI{11.545}{us}$ \\ \hline
	\tabincell{c}{$\Delta \phi_\mathit{rf}$}&$\pm1.2^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   $f_\mathit{bucket}$ & $f_{\mathit{syn}}^{ESR}=\SI{219.642}{\kHz}$  \\ \hline
	...
	\tabincell{c}{$T_w$}& $T_{\mathit{syn}}^{ESR}=\SI{4.553}{us}$ \\ \hline
	\tabincell{c}{$\Delta \phi_\mathit{rf}$}&$\pm31.2^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
