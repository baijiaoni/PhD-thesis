...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{l}$\\ \hline
	...
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2/f_{\mathit{rev}}^{l}}{1/\Delta f}\cdot360^\circ$ \\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{s}$ & $f_{\mathit{syn}}^{s}$ \\ \hline
	...
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2/f_{\mathit{rev}}^{s}}{1/\Delta f}\cdot360^\circ$ & $\pm\frac{1}{2}\cdot\frac{2/f_{\mathit{syn}}^{s}}{1/\Delta f}\cdot360^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{\mathit{SIS100}}$  \\ \hline
	\tabincell{c}{Two slightly \\different\\ frequencies} & $f_{\mathit{syn}}^{s}+\Delta f=f_{\mathit{rf}}^{\mathit{SIS18}}+200Hz$ and $f_{\mathit{syn}}^{l}=f_{\mathit{rf}}^{\mathit{SIS100}}$\\ \hline
	\tabincell{c}{Length of \\synchronization\\ window}& $2/f_{\mathit{rev}}^{\mathit{SIS100}}=\SI{12.718}{us}$\\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2/f{\mathit{rev}}^{\mathit{SIS100}}}{1/200}\cdot360^\circ=\pm0.50^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{\mathit{SIS100}}$  \\ \hline
	\tabincell{c}{Two slightly \\different\\ frequencies} & $f_{\mathit{syn}}^{s}+\Delta f=f_{\mathit{rf}}^{\mathit{SIS18}}+\SI{200}{Hz}$ and $f_{\mathit{syn}}^{l}=f_{\mathit{rf}}^{\mathit{SIS100}}/2$ \\ \hline
	\tabincell{c}{Length of \\synchronization\\ window}& $2/f_{\mathit{rev}}^{\mathit{SIS100}}=\SI{7.356}{us}$ \\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{/f_{\mathit{rev}}^{\mathit{SIS100}}}{1/200}\cdot360^\circ=\pm0.31^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
%%%%%%%%%%%
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{syn}}^{s}$  \\ \hline
	\tabincell{c}{Two slightly \\different\\ frequencies} & $f_{\mathit{syn}}^{l}+\Delta f=f_{\mathit{rf}}^{\mathit{ESR}}+200Hz$ and $f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{\mathit{CRYRING}}}{2}$\\ \hline
	\tabincell{c}{Length of \\synchronization\\ window}& $2/f_{\mathit{syn}}^{\mathit{s}})=\SI{5.488}{us}$ \\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2/f_{\mathit{syn}}^{\mathit{s}}}{1/200}\cdot360^\circ=\pm0.20^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
Two synchronization rf frequencies are beating automatically. When the large synchrotron is the target, the bucket label signal is with the frequency of $f_{\mathit{rev}}^{l}$, because $f_{\mathit{syn}}^{l}>=f_{\mathit{rev}}^{l}$. Tab.~\ref{Syn_rev_large_close} shows the formulas for the frequency of the bucket label signal, two slightly different frequencies for beating, the length of the synchronization window and the bunch and bucket center mismatch when the large synchrotron is the target.
...
When the small synchrotron is the target, the frequency of the bucket label signal is dependent on the relation between $f_{\mathit{syn}}^{s}$ and $f_{\mathit{rev}}^{s}$. When $f_{\mathit{syn}}^{s}>=f_{\mathit{rev}}^{s}$, the revolution period is longer than the period for the phase alignment. Hence, the frequency of the bucket label signal is $f_{\mathit{rev}}^{s}$. Or the bucket label signal with the frequency of $f_{\mathit{syn}}^{s}$. Tab.~\ref{Cir ratio close to integer} shows the formulas when the small synchrotron is the target.
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{\mathit{ESR}}$  \\ \hline
	...
	\tabincell{c}{Length of \\synchronization\\ window}& $2/f_{\mathit{rev}}^{\mathit{ESR}}=\SI{0.729}{us}$ \\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2/f_{\mathit{rev}}^{\mathit{ESR}}}{1/1898}\cdot360^\circ=\pm0.27^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{syn}}^{s}$  \\ \hline
	...
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2/f_{\mathit{syn}}^{\mathit{s}}}{1/1368}\cdot360^\circ=\pm0.50^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{l}$ &$f_{\mathit{syn}}^{l}$ \\ \hline
	...
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2/f_{\mathit{rev}}^{l}}{1/\Delta f}\cdot360^\circ$ & $\pm\frac{1}{2}\cdot\frac{2/f_{\mathit{syn}}^{l}}{1/\Delta f}\cdot360^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
When the small synchrotron is the target, the frequency of the bucket label signal is dependent on the relation between $f_{\mathit{syn}}^{s}$ and $f_{\mathit{rev}}^{s}$. When $f_{\mathit{syn}}^{s}>=f_{\mathit{rev}}^{s}$, namely $\frac{Y}{m}>=1$ the revolution period is longer than the period for the phase alignment. Hence, the frequency of the bucket label signal is $f_{\mathit{rev}}^{s}$. Or the bucket label signal with the frequency of $f_{\mathit{syn}}^{s}$. Tab.~\ref{Cir ratio far from integer small} shows the formulas when the small synchrotron is the target.
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{syn}}^{s}$  \\ \hline
	...
	\tabincell{c}{Length of \\synchronization\\ window}& $2/f_{\mathit{syn}}^{s}=\SI{74.382}{us}$ \\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2/f_{\mathit{syn}}^{s}}{1/215}\cdot360^\circ=\pm2.88^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
The GCD of $h^{\mathit{SIS100}}\cdot n=2\cdot5=10$ and $h^{\mathit{CR}} \cdot m=1\cdot 22=22$ is 2, namely $Y=2$. CR is the small synchrotron and the target and there exists $\frac{Y}{m}=1/22<1$, so substituting $h^X$, $m$, $n$, $\lambda$, $f_{\mathit{rf}}^{X}$ and Y into formulas in the last column in Tab.~\ref{Cir ratio far from integer small}, the synchronization of RIB B2B transfer from SIS100 to CR is obtained, see Tab.~\ref{tab:100toCRrib}.
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{syn}}^{s}$  \\ \hline
	...
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2/f_{\mathit{syn}}^{s}}{1/54}\cdot360^\circ=\pm0.39^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
	...
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2/f_{\mathit{syn}}^{l}}{1/136}\cdot360^\circ=\pm0.48^\circ$\\ \hline
		\rowcolor[gray]{0.8}
 		&\SI{740}{MeV/\atomicmassunit} RIB \\ \hline
	\tabincell{c}{Two slightly \\different\\ frequencies} & $f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{\mathit{CR}}}{13}=\SI{86.493}{\kHz}$ and $f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{\mathit{HESR}}}{5}=\SI{86.608}{\kHz}$\\ \hline
	...
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2/f_{\mathit{syn}}^{l}}{1/113}\cdot360^\circ=\pm0.47^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{syn}}^{s}$  \\ \hline
	...
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2/f_{\mathit{syn}}^{s}}{1/4249}\cdot360^\circ=\pm6.92^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
