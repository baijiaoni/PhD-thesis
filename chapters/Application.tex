...
%     	\multirow{3}*{A} &  5&& 10 & 2 & $\frac{h^l}{h^s\cdot \kappa}=\frac{10}{2\cdot 5}=1$ & $U^{28+}$ \tabincell{c}{B2B transfer \\from SIS18 to SIS100} \\ \cline{2-7}
%& 5&& 10 & 1 & $\frac{h^l}{h^s\cdot \kappa}=\frac{10}{1\cdot 5}=2$ &\tabincell{c}{$H^{+}$ B2B transfer \\from SIS18 to SIS100} \\ \cline{2-7}
%											&5 && 2& 1  & $\frac{h^l}{h^s\cdot \kappa}=\frac{1}{1\cdot 2}=\frac{1}{2}$ &\tabincell{c}{B2B transfer\\ from ESR to CRYRING} \\ \hline
%     	\multirow{2}*{B}&2-0.003& &4&1 & $\frac{h^l}{h^s\cdot (\kappa+ \lambda)}=\frac{4}{1\cdot (2-0.003)}$ & \tabincell{c}{h=4 B2B transfer \\from SIS18 to ESR} \\ \cline{2-7}
% 								  	  &2-0.003&& 1&1 &$\frac{h^l}{h^s\cdot (\kappa+ \lambda)}=\frac{1}{1\cdot (2-0.003)}$ & \tabincell{c}{h=1 B2B transfer\\ from SIS18 to ESR}\\ \cline{1-7}
% 									
%
%  	\multirow{4}*{C}
%&&4.9-0.0004& 5&1 &$\frac{h^l}{h^s \cdot (m/n+ \lambda)}=\frac{5}{1 \cdot (49/10-0.0004)}$ & \tabincell{c}{$H^{+}$ B2B transfer\\ from SIS100 to CR} \\ \cline{2-7}
%& &4.9-0.0004& 2&1 & $\frac{h^l}{h^s \cdot (m/n+ \lambda)}=\frac{2}{1 \cdot (49/10-0.0004)}$ & \tabincell{c}{RIB B2B transfer \\from SIS100 to CR} \\ \cline{2-7}
%
%& 2.6-0.003& &1&1 &$\frac{h^l}{h^s \cdot (m/n+ \lambda)}=\frac{1}{1 \cdot (13/5-0.003)}$ &\tabincell{c}{B2B transfer\\ from CR to HESR} \\ \cline{2-7}
%
% &&1.8+0.048& 1&1 & $\frac{h^l}{h^s \cdot (m/n+ \lambda)}=\frac{9}{5}+0.048$ & \tabincell{c}{B2B transfer \\from SIS18 to ESR via FRS} \\ \hline
% 
%
%    \end{tabular}
%\end{center}
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{l}$\\ \hline
	\tabincell{c}{Two slightly \\different\\ frequencies} & $f_{\mathit{syn}}^{s}+\Delta f$ and $f_{\mathit{syn}}^{l}$ \\ \hline
	\tabincell{c}{Length of \\synchronization\\ window}& $2\cdot T_{\mathit{rev}}^{l}$ \\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2\cdot T_{\mathit{rev}}^{l}}{1/\Delta f}\cdot360^\circ$ \\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{s}$ & $f_{\mathit{syn}}^{s}$ \\ \hline
	\tabincell{c}{Two slightly \\different\\ frequencies} & \multicolumn{2}{c|}{$f_{\mathit{syn}}^{l}+\Delta f$ and $f_{\mathit{syn}}^{s}$}\\ \hline
	\tabincell{c}{Length of \\synchronization\\ window}& $2\cdot T_{\mathit{rev}}^{s}$ & $2/f_{\mathit{syn}}^{s}=2\cdot [(h^s\cdot \kappa)/Y]\cdot T_{\mathit{rf}}^{s}$\\ \hline
...
%	\tabincell{c}{Two slightly \\different\\ frequencies} & \multicolumn{2}{c|}{$\frac{f_{\mathit{rf}}^{l}}{h^l/Y}$ and $\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot \kappa)/Y}+\Delta f$ or $\frac{f_{\mathit{rf}}^{l}}{h^l/Y}+\Delta f$ and $\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot \kappa)/Y}$}\\ \hline
...
For the frequency beating method, the frequency is detuned either for SIS18 or SIS100, becuase of $h^{\mathit{SIS100}} = h^{\mathit{SIS18}} \cdot \kappa$. Because SIS100 is the target, substituting $h^X$, $\kappa$, $f_{\mathit{rf}}^{X}$, $f_{\mathit{rev}}^{X}$ and $Y$ into formulas in Tab.~\ref{Syn_rev_large}, the synchronization of $U^{28+}$ B2B transfer from SIS18 to SIS100 is obtained, see Tab.~\ref{tab:U18to100}. Here we assume that SIS18 is detuned with \SI{200}{Hz}. 
\begin{table}[!htb]
\newcommand{\tabincell}[2]{\begin{tabular}{@{}#1@{}}#2\end{tabular}}
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{\mathit{SIS100}}$  \\ \hline
	...
	\tabincell{c}{Length of \\synchronization\\ window}& $2\cdot T_{\mathit{rev}}^{\mathit{SIS100}}=\SI{12.718}{us}$\\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2 \cdot T_{\mathit{rev}}^{\mathit{SIS100}}}{1/200}\cdot360^\circ=\pm0.50^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}

After the synchronization, the phase difference between the SIS18 and SIS100 revolution frequency markers equals to the sum of $t_{v\_inj}$, $t_{v\_ext}$ and $t_{TOF}$. The SIS100 revolution frequency marker works for the bucket label. When the 1st and 2nd buckets are to be filled, $t_{pattern}$=0. When the 3rd and 4th buckets, $t_{pattern}$=$T_{\mathit{rev}}^{\mathit{SIS18}}$. When the 5th and 6th buckets, $t_{pattern}$= 2 $\cdot$ $T_{\mathit{rev}}^{\mathit{SIS18}}$. When the 7th and 8th buckets, $t_{pattern}$= 3 $\cdot$ $T_{\mathit{rev}}^{\mathit{SIS18}}$. Detailed parameters of $U^{28+}$ B2B transfer from SIS18 to SIS100, please see Appendix \ref{sec:18to100}.
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{\mathit{SIS100}}$  \\ \hline
	\tabincell{c}{Two slightly \\different\\ frequencies} & $f_{\mathit{rf}}^{\mathit{SIS18}}+\Delta f$ and $\frac{f_{\mathit{rf}}^{\mathit{SIS100}}}{2}$ \\ \hline
	\tabincell{c}{Length of \\synchronization\\ window}& $2\cdot T_{\mathit{rev}}^{\mathit{SIS100}}=\SI{7.356}{us}$ \\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2\cdot  T_{\mathit{rev}}^{\mathit{SIS100}}}{1/200}\cdot360^\circ=\pm0.31^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
%%%%%%%%%%%
...
\begin{itemize}
	\item Injection into the odd number buckets
		...
		The phase difference between the SIS18 and SIS100 revolution frequency markers equals to $t_{v\_ext}$+$t_{v\_inj}$+ $t_{TOF}$. When the 1st bucket is to be filled, $t_{pattern}$=0. When the 3rd bucket is to be filled, $t_{pattern}$=2 $\cdot$ $T_{\mathit{rev}}^{\mathit{SIS18}}$. 
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $1/2f_{\mathit{rf}}^{\mathit{CRYRING}}$  \\ \hline
	...
	\tabincell{c}{Length of \\synchronization\\ window}& $2\cdot (2\cdot T_{\mathit{rf}}^{\mathit{CRYRING}})=\SI{5.488}{us}$ \\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2\cdot 2\cdot T_{\mathit{rf}}^{\mathit{CRYRING}}}{1/200}\cdot360^\circ=\pm0.20^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
Two synchrotrons are beating automatically. Two slightly different frequencies are $f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{l}}{h^l/Y}$ and $f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot \kappa)/Y}$. When the large synchrotron is the target, the bucket label signal is with the frequency of $f_{\mathit{rev}}^{l}$, because $f_{\mathit{syn}}^{l}>=f_{\mathit{rev}}^{l}$. Tab.~\ref{Syn_rev_large_close} shows the formulas for the frequency of the bucket label signal, two slightly different frequencies for beating, the length of the synchronization window and the bunch and bucket center mismatch when the large synchrotron is the target.
...
\begin{center}
	...
	&  Large synchrotron is target synchrotron \\ \hline
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{l}$\\ \hline
	\tabincell{c}{Two slightly \\different\\ frequencies} & $f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot \kappa)/Y}$ and $f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{l}}{h^l/Y}$ \\ \hline
	\tabincell{c}{Beating \\ frequencies} & $\Delta f= |\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot \kappa)/Y}-\frac{f_{\mathit{rf}}^{l}}{h^l/Y}|$ \\ \hline
	\tabincell{c}{Length of \\synchronization\\ window}& $2\cdot T_{\mathit{rev}}^{l}$ \\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2\cdot T_{\mathit{rev}}^{l}}{1/\Delta f}\cdot360^\circ$ \\ \hline
    \end{tabular}
\end{center}
...
When the small synchrotron is the target, the frequency of the bucket label signal is dependent on the relation between $\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot \kappa)/Y}$ and $f_{\mathit{rev}}^{s}$. When $\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot \kappa)/Y}>=f_{\mathit{rev}}^{s}$, the revolution period is longer than the period for the phase alignment. Hence, the frequency of the bucket label signal is $f_{\mathit{rev}}^{s}$. Or the bucket label signal with the frequency of $\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot \kappa)/Y}$. Tab.~\ref{Cir ratio close to integer} shows the formulas when the small synchrotron is the target.
...
\begin{center}
    ...
    \hline
	&  \multicolumn{2}{c|}{Small synchrotron is target synchrotron} \\ \hline
	Cases& \tabincell{c}{ $\frac{f_{\mathit{rf}}^{s}}{(h^s \cdot\kappa)/Y}>=f_{\mathit{rev}}^{s}$ \\ \\($\frac{Y}{\kappa}>=1$) } &\tabincell{c}{ $\frac{f_{\mathit{rf}}^{s}}{(h^s \cdot\kappa)/Y}<f_{\mathit{rev}}^{s}$ \\ \\ ($\frac{Y}{\kappa}<1$) } \\ \hline
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{s}$ &$\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot \kappa)/Y}$ \\ \hline
	\tabincell{c}{Two slightly \\different\\ frequencies} & \multicolumn{2}{c|}{$f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{l}}{h^l/Y}$ and $f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot \kappa)/Y}$}\\ \hline
	\tabincell{c}{Beating\\ frequencies} & \multicolumn{2}{c|}{$\Delta f=|\frac{f_{\mathit{rf}}^{l}}{h^l/Y} - \frac{f_{\mathit{rf}}^{s}}{(h^s\cdot \kappa)/Y}|$}\\ \hline
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{\mathit{ESR}}$  \\ \hline
	\tabincell{c}{Two slightly \\different\\ frequencies} & $f_{\mathit{syn}}^{l}=f_{\mathit{rf}}^{\mathit{SIS18}}=\SI{1.373200}{\MHz}$ and $f_{\mathit{syn}}^{s}=f_{\mathit{rf}}^{\mathit{ESR}}=\SI{1.371302}{\MHz}$\\ \hline
	\tabincell{c}{Beating\\ frequencies} & \SI{1898}{\Hz}\\ \hline
	\tabincell{c}{Length of \\synchronization\\ window}& $2\cdot \cdot T_{\mathit{rf}}^{\mathit{ESR}}=\SI{0.729}{us}$ \\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2\cdot \cdot T_{\mathit{rf}}^{\mathit{ESR}}}{1/1898}\cdot360^\circ=\pm0.27^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $\frac{f_{\mathit{rf}}^{\mathit{ESR}}}{2}$  \\ \hline
	\tabincell{c}{Two slightly \\different\\ frequencies} & $f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{\mathit{SIS18}}}{1}=\SI{989.756}{\kHz}$ and $f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{\mathit{ESR}}}{2}=\SI{988.388}{\kHz}$\\ \hline
	\tabincell{c}{Beating\\ frequencies} & \SI{1368}{\Hz}\\ \hline
	\tabincell{c}{Length of \\synchronization\\ window}& $2\cdot 2\cdot T_{\mathit{rf}}^{\mathit{ESR}}=\SI{2.034}{us}$ \\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2\cdot 2\cdot T_{\mathit{rf}}^{\mathit{ESR}}}{1/1368}\cdot360^\circ=\pm0.50^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
	...
	Cases& \tabincell{c}{ $\frac{f_{\mathit{rf}}^{l}}{(h^l\cdot n)/Y}>=f_{\mathit{rev}}^{l}$ \\ \\($\frac{Y}{n}>=1$) } &\tabincell{c}{ $\frac{f_{\mathit{rf}}^{l}}{(h^l\cdot n)/Y}<f_{\mathit{rev}}^{l}$ \\ \\ ($\frac{Y}{n}<1$) } \\ \hline
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{l}$ &$\frac{f_{\mathit{rf}}^{l}}{(h^l\cdot n)/Y}$ \\ \hline
	\tabincell{c}{Two slightly \\different\\ frequencies} & \multicolumn{2}{c|}{$f_{\mathit{syn}}^{s}=f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot m)/Y}$ and $f_{\mathit{syn}}^{l}=f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{l}}{(h^l\cdot n)/Y}$}\\ \hline
	\tabincell{c}{Beating\\ frequencies} & \multicolumn{2}{c|}{$\Delta f=|\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot m)/Y}-\frac{f_{\mathit{rf}}^{l}}{(h^l\cdot n)/Y}|$}\\ \hline

	\tabincell{c}{Length of \\synchronization\\ window}& $2\cdot T_{\mathit{rev}}^{l}$ & $2\cdot [(h^l\cdot n)/Y]\cdot T_{\mathit{rf}}^{l}$\\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2\cdot T_{\mathit{rev}}^{l}}{1/\Delta f}\cdot360^\circ$ & $\pm\frac{1}{2}\cdot\frac{2\cdot [(h^l\cdot n)/Y]\cdot T_{\mathit{rf}}^{l}}{1/\Delta f}\cdot360^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
    ...
    \hline
	&  \multicolumn{2}{c|}{Small synchrotron is target synchrotron} \\ \hline
	Cases& \tabincell{c}{ $\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot m)/Y}>=f_{\mathit{rev}}^{s}$ \\ \\($\frac{Y}{m}>=1$) } &\tabincell{c}{ $\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot m)/Y}<f_{\mathit{rev}}^{s}$ \\ \\ ($\frac{Y}{m}<1$) } \\ \hline
   \tabincell{c}{Frequency \\ of bucket label} & $f_{\mathit{rev}}^{s}$ &$\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot m)/Y}$ \\ \hline
	\tabincell{c}{Two slightly \\different\\ frequencies} & \multicolumn{2}{c|}{$f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot m)/Y}$ and $f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{l}}{(h^l\cdot n)/Y}$}\\ \hline
	\tabincell{c}{Beating\\ frequencies} & \multicolumn{2}{c|}{$\Delta f=|\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot m)/Y}-\frac{f_{\mathit{rf}}^{l}}{(h^l\cdot n)/Y}|$}\\ \hline

	\tabincell{c}{Length of \\synchronization\\ window}& $2\cdot T_{\mathit{rev}}^{s}$ & $2\cdot [(h^s\cdot m)/Y]\cdot T_{\mathit{rf}}^{s}$\\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2\cdot T_{\mathit{rev}}^{s}}{1/\Delta f}\cdot360^\circ$ & $\pm\frac{1}{2}\cdot\frac{2\cdot [(h^s\cdot m)/Y]\cdot T_{\mathit{rf}}^{s}}{1/\Delta f}\cdot360^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
There are various combination of $\frac{m}{n}$ and $\lambda$, $\lambda$ determines the beating speed. The smaller, the more precise bunch-to-bucket injection. $(h^l\cdot n)/Y$ and $(h^s\cdot m)/Y$ determines the two slightly different frequencies. The bigger $(h^l\cdot n)/Y$ and $(h^s\cdot m)/Y$, the smaller two slightly different frequencies, which has higher requirement for LLRF system. So we have to find a balance between the precision of the bunch-to-bucket injection and the low frequencies for beating.

Two slightly different frequencies could also be a fraction (between 1/Y and 1) times of the $\frac{f_{\mathit{rf}}^{l}}{(h^l\cdot n)/Y}$ and $\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot m)/Y}$, see Sec. ~\ref{sec:close_to_int}.
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $\frac{f_{\mathit{rf}}^{\mathit{CR}}}{49}$  \\ \hline
	\tabincell{c}{Two slightly \\different\\ frequencies} & $f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{\mathit{SIS100}}}{50}=\SI{26.658}{\kHz}$ and $f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{\mathit{CR}}}{49}=\SI{26.873}{\kHz}$\\ \hline
	\tabincell{c}{Beating\\ frequencies} & \SI{215}{\Hz}\\ \hline
	\tabincell{c}{Length of \\synchronization\\ window}& $2\cdot 49\cdot T_{\mathit{rf}}^{\mathit{CR}}=\SI{74.382}{us}$ \\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2\cdot 49\cdot T_{\mathit{rev}}^{\mathit{CR}}}{1/215}\cdot360^\circ=\pm2.88^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $\frac{f_{\mathit{rf}}^{\mathit{CR}}}{11}$  \\ \hline
	\tabincell{c}{Two slightly \\different\\ frequencies} & $f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{\mathit{SIS100}}}{5}=\SI{102.326}{\kHz}$ and $f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{\mathit{CR}}}{11}=\SI{102.218}{\kHz}$\\ \hline
	\tabincell{c}{Beating\\ frequencies} & \SI{108}{\Hz}\\ \hline
	\tabincell{c}{Length of \\synchronization\\ window}& $2\cdot (22/2)\cdot T_{\mathit{rf}}^{\mathit{CR}}=\SI{19.558}{us}$ \\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2\cdot 22\cdot T_{\mathit{rev}}^{\mathit{CR}}}{1/54}\cdot360^\circ=\pm0.39^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
One bunch of CR is injected into one bucket of HESR. The beam is accumulated in HESR ~\cite{toelle_hesr_2007}. The large synchrotron is HESR and the small one is CR. $h^{\mathit{HESR}}=1$ and $h^{\mathit{CR}}=1$. The GCD of $h^{\mathit{HESR}}\cdot n=1\cdot5=5$ and $h^{\mathit{CR}} \cdot m=1\cdot 13=13$ is 1, namely $Y=1$. Substituting the circumference of HESR and CR to eq.~\ref{circumference_ratio_noint11}, we have
...
\begin{center}
	...
	\tabincell{c}{Two slightly \\different\\ frequencies} & $f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{\mathit{CR}}}{13}=\SI{101.290}{\kHz}$ and $f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{\mathit{HESR}}}{5}=\SI{101.426}{\kHz}$\\ \hline
	\tabincell{c}{Beating\\ frequencies} & \SI{136}{\Hz}\\ \hline
	\tabincell{c}{Length of \\synchronization\\ window}& $2\cdot 5\cdot T_{\mathit{rf}}^{\mathit{HESR}}=\SI{19.719}{us}$ \\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2\cdot 5\cdot T_{\mathit{rev}}^{\mathit{CR}}}{1/136}\cdot360^\circ=\pm0.48^\circ$\\ \hline
		\rowcolor[gray]{0.8}
	...
	\tabincell{c}{Length of \\synchronization\\ window}& $2\cdot 5\cdot T_{\mathit{rf}}^{\mathit{HESR}}=\SI{23.090}{us}$ \\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2\cdot 5\cdot T_{\mathit{rev}}^{\mathit{CR}}}{1/113}\cdot360^\circ=\pm0.47^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
   ...
   \tabincell{c}{Frequency \\ of bucket label} & $\frac{f_{\mathit{rf}}^{\mathit{ESR}}}{9}$  \\ \hline
	\tabincell{c}{Two slightly \\different\\ frequencies} & $f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{\mathit{SIS18}}}{5}=\SI{215.393}{\kHz}$ and $f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{\mathit{ESR}}}{9}=\SI{219.642}{\kHz}$\\ \hline
	\tabincell{c}{Beating\\ frequencies} & \SI{4.249}{\kHz}\\ \hline
	\tabincell{c}{Length of \\synchronization\\ window}& $2\cdot 9\cdot T_{\mathit{rf}}^{\mathit{ESR}}=\SI{9.106}{us}$ \\ \hline
	\tabincell{c}{Bunch-to-bucket\\injection\\center\\ mismatch}&$\pm\frac{1}{2}\cdot\frac{2\cdot 9\cdot T_{\mathit{rev}}^{\mathit{ESR}}}{1/4249}\cdot360^\circ=\pm6.92^\circ$\\ \hline
    \end{tabular}
\end{center}
\end{table}
...
\begin{center}
 ...
 \tabincell{c}{$C^l/C^s=\kappa$ \\Integer} &  \tabincell{c}{$\frac{h^l}{h^s\cdot \kappa}$\\ \\ $Y=GCD(h^l,h^s\cdot \kappa)$} & \tabincell{c}{$\frac{f_{\mathit{rf}}^{l}}{h^l/Y}$ \\ \\ \color{red}{$\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot \kappa)/Y}$}} & \tabincell{c}{$f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{l}}{h^l/Y}$ and $f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot \kappa)/Y}+\Delta f$\\ or\\ $f_{\mathit{syn}}^{l}=\frac{f_{\mathit{rf}}^{l}}{h^l/Y}+\Delta f$ and $f_{\mathit{syn}}^{s}=\frac{f_{\mathit{rf}}^{s}}{(h^s\cdot \kappa)/Y}$}&\tabincell{c}{$\pm\frac{1}{2}\cdot\frac{2\cdot (h^l/Y) \cdot T_{\mathit{rf}}^{l}}{1/\Delta f}\cdot360^\circ$ \\ \\ \color{red}{$\pm\frac{1}{2}\cdot\frac{2\cdot ([(h^s\cdot \kappa)/Y])\cdot T_{\mathit{rf}}^{s}}{1/\Delta f}\cdot360^\circ$}}\\ \hline
