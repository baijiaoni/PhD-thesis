\section{Parameters related to the B2B transfer from SIS18 to SIS100}
\label{sec:18to100}
...
%\multicolumn{6}{|c|}{\tabincell{c}{For SIS18, it is impossible to change the orbit to match the RF frequency \\within the radius excursion range. So the phase shift method could \\not be implemented}} \\ \hline
	\caption{Parameters related to the B2B transfer from SIS18 to SIS100}
	\label{18to100}
\end{longtable}
% 
% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{Parameters related to the B2B transfer from SIS18 to ESR}
\label{sec:18toESR}
%\begin{landscape} 
...
%\tabincell{c}{$\Delta R/R$ for RF \\frequency match}&&\multicolumn{2}{c|}{0.2$\%$}&\multicolumn{2}{c|}{0.1$\%$} \\ \hline
%\multicolumn{6}{|c|}{\tabincell{c}{For SIS18, it is impossible to change the orbit to match the RF frequency \\within the radius excursion range. So the phase shift method could \\not be implemented}} \\ \hline
\caption{Parameters related to the B2B transfer from SIS18 to ESR}
\label{18toESR}
    \end{longtable}
% 
% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{Parameters related to the B2B transfer from SIS18 to ESR via FRS}
...
\caption{Parameters related to the B2B transfer from SIS18 to ESR via FRS}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{Parameters related to the B2B transfer from ESR to CRYRING}
...
%    \caption{Parameters related to the B2B transfer from ESR to CRYRING}
%	\label{ESRtoCRYRING}
\end{longtable}
...
\caption{Parameters related to the B2B transfer from CR to HESR}
\label{CRtoHESR}
    \end{longtable}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{Parameters related to the B2B transfer from SIS100 to CR}
\label{100toCR}
%\begin{landscape} 
...
\caption{Parameters related to the B2B transfer from  SIS100 to CR}
\label{100toCR}
    \end{longtable}
